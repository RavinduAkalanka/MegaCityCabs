...
<div class="container">
    <h2 class="form-title">Update Cab</h2>
    <p class="form-subtitle">Update the details of the cab below.</p>
    ...
    <form id="updateCabForm" action="<%= request.getContextPath() %>/cab-update-servlet" method="POST">
        ...
        <div class="row"> <!-- Start of row for two columns -->
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="vehicleNo" name="vehicleNo" value="${cab.vehicleNo}" required>
                    <div id="vehicleNoError" class="error"></div>
                </div>

                <div class="mb-3">
                    <label for="owner" class="form-label">Owner</label>
                    <input type="text" class="form-control" id="owner" name="owner" value="${cab.owner}" required>
                    <div id="ownerError" class="error"></div>
                </div>

                <div class="mb-3">
                    <label for="fuelType" class="form-label">Fuel Type</label>
                    <input type="text" class="form-control" id="fuelType" name="fuelType" value="${cab.fuelType}" required>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="pricePerKM" name="pricePerKM" value="${cab.pricePerKM}" required>
                    <div id="pricePerKMError" class="error"></div>
                </div>

                <div class="mb-3">
                    <label for="capacity" class="form-label">Capacity</label>
                    <input type="number" class="form-control" id="capacity" name="capacity" value="${cab.capacity}" required>
                    <div id="capacityError" class="error"></div>
                </div>

                <div class="mb-3">
                    <label for="cabImgUrl" class="form-label">Cab Image URL</label>
                    <input type="text" class="form-control" id="cabImgUrl" name="cabImgUrl" value="${cab.cabImgUrl}">
                    <div id="cabImgUrlError" class="error"></div>
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label">Description</label>
                    <textarea class="form-control" id="description" name="description">${cab.description}</textarea>
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-custom">Update Cab</button>
...
<script>
    document.getElementById('updateCabForm').onsubmit = function(event) {
        let isValid = true;
